...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log('Attempting login with auth manager');
      ...
      const userRole = result.data?.user?.role || 'agent';
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>• Use your unique Agent ID (not email) to log in</li>
                  <li>• Your session will be secure and encrypted</li>
                  <li>• Always log out when finished</li>
                  <li>• Contact support if you've forgotten your Agent ID</li>
                </ul>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm">
                  <Link href="/forgot-password" className="font-medium text-indigo-600 hover:text-indigo-500">
                    Forgot your Agent ID or password?
                  </Link>
                </div>
              </div>
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <h4 className="text-sm font-semibold text-yellow-800 mb-2">📧 Need your Agent ID?</h4>
            <p className="text-sm text-yellow-700">
              Your Agent ID was sent to your email when you registered. Check your inbox (and spam folder) for the welcome email containing your unique Agent ID.
            </p>
          </div>
        </div>
      </div>
